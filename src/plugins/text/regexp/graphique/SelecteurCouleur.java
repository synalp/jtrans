...
/** JColorChooser simplifié	 */
public class SelecteurCouleur extends JColorChooser {

    public SelecteurCouleur() {
        setPreviewPanel(new JPanel());
        AbstractColorChooserPanel[] list = getChooserPanels();
        removeChooserPanel(list[1]);
        removeChooserPanel(list[2]);
    }
