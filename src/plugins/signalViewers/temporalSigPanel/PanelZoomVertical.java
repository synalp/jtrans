...
/** Panel de reglage du zoom vertical du TemporalSigPanel. */
public class PanelZoomVertical extends JToolBar {

	//---------- Private Fields ------------
	private TemporalSigPanel temporalSigPanel;

	//---------- Constructor ------------
	public PanelZoomVertical(TemporalSigPanel temporalSig) {
		super();
		this.temporalSigPanel = temporalSig;

		this.setFloatable(false);
		
		JSlider vZoomSlider = new JSlider(JSlider.VERTICAL,1,3000,temporalSigPanel.getVZoom());
		vZoomSlider.setInverted(true);
		vZoomSlider.setToolTipText("Zoom vertical");
		vZoomSlider.addChangeListener(new ChangeListener(){
			public void stateChanged(ChangeEvent arg0) {
				temporalSigPanel.setVZoom((Integer)(((JSlider)arg0.getSource()).getModel().getValue()));
			}
		});
		add(vZoomSlider);
	}//constructor
