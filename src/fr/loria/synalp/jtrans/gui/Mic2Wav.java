...
//		JOptionPane.showMessageDialog(null, "wav saved in "+waveout);
	...
	public Mic2Wav(int mixidx) {
		...
		mike = new Microphone(16000, 16, 1, true, true, true, 10, false, "average", 0, ""+mixidx, 6400);
	...
	private static Mic2Wav unik = null;
	private int mxidx=0;
	
	/**
	 * Mic2Wav prévient lorsqu'un nouveau fichier .wav a été enregistré
	 * @param al
	 */
