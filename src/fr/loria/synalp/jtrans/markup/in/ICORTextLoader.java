...
/**
 * Parser for raw transcription text from ICOR (ICAR Lab).
 * Author : Matthieu Quignard
 * BUGS : don't really manage laughs, overlaps and given timings 
 * NB : don't use normalizeText method
 */
public class ICORTextLoader implements MarkupLoader {
	/**
	...
	{{
		...
		// PONCTUATION : allongement, troncation, ton montant, descendant, pauses chrono ou pas
		put(Token.Type.PUNCTUATION,        "(\\:|\\-|/|\\\\|\\(\\.\\)|\\(\\d+\\.\\d\\))");
		// LOCUTEURS :  Une ligne commençant par une chaîne de 1 à 3 caractères, suivie d'une tabulation
...
//		System.out.println("list "+list);
	...
	public ICORTextLoader(Map<Token.Type, String> commentPatterns) {
		this.commentPatterns = commentPatterns;
	}


	public ICORTextLoader() {
