...
//	LanguageModel lm;
	...
	public List<RecoWord2> getWords() {
		ArrayList<RecoWord2> ws = new ArrayList<RecoWord2>();
		try {
			...
			for (int i = 0; i < words.length; i++) {
				...
				ws.add(new RecoWord2(wordResult.getPronunciation().getWord().getSpelling(),wordConfidence));
			}
		} catch (Error e) {
			e.printStackTrace();
		}
