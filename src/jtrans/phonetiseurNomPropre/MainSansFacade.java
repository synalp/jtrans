...
/**
 * Ce Main regroupe differentes utilisation du phonetiseur, sans utiliser la jtrans.facade
 */
public class MainSansFacade {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String nomFichierProbasLangues = "nompropres.vecteurs";
...
//      /********************************/
        phonetiseur.genererFichiersVecteursARFF(nomRepTravail + "ARFF/", nomRepListesDeMots + nomFichierProbasLangues);
//
//      /*************************************************/
...
//      /*******************************************/
        System.out.println("Avec posTag : " + phonetiseur.testerAvecPosTag(pL, nomRepListesDeMots + nomFichierMotsTEST, nomRepTravail + "mauvaisesPhonetisationsAvecPosTag.txt", nomRepListesDeMots + nomFichierProbasLangues) + "%");
        System.out.println("Sans posTag : " + phonetiseur.testerSansPosTag(pL, nomRepListesDeMots + nomFichierMotsTEST, nomRepTravail + "mauvaisesPhonetisationsSansPosTag.txt", nomRepListesDeMots + nomFichierProbasLangues) + "%");
        System.out.println("Avec posTag sur Train : " + phonetiseur.testerAvecPosTag(pL, nomRepListesDeMots + nomFichierMotsTRAIN, nomRepTravail + "mauvaisesPhonetisationsAvecPosTag_SUR_TRAIN.txt", nomRepListesDeMots + nomFichierProbasLangues) + "%");
    }
}
