...
public class AlignementGraphemesPhonemes {
    ...
    public static void main(String args[]) {
    	String[] phs = args[0].replace('_', ' ').split(" ");
    	String[] grs = args[1].replace('_', ' ').split(" ");
    	Phonetiseur m = new Phonetiseur();
    	AlignementGraphemesPhonemes n = m.alignerGraphemesPhonemes(grs, phs, false, false);
     ...
     * @param stringGraphemeVide le grapheme vide
     */
    public String[] getVecteur_Methode_4Classifieurs(String debutDeMot, String finDeMot, String posTag, String stringGraphemeVide) {
